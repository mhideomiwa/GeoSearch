        ...
        <div className="relative w-full h-full">
            ...
            {showButton && (
                <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
                    <Link href="/Score">
                        <button
                            className="bg-blue-600 text-white font-bold px-6 py-3 rounded-full hover:bg-blue-700 hover:scale-105 transform transition duration-200 ease-in-out shadow-md hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-300">
                            Confirm Guess
                        </button>
                    </Link>
                </div>
